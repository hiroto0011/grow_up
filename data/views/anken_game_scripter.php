...
echo $this->layout('contentArea', array(
	'title' => 'スマートフォンゲームの開発スクリプターの案件',
	'content' => $this->yield('content'),
	'breadcrumbs' => array(
		'TOP',
		'案件情報',
		'スマートフォンゲームの開発スクリプターの案件'
	),
	'sidebar_menu' => array(
  ...
  <div class="contentsl_1">
	<dl>
		<dt class="anken-title">案件名</dt>
			<dd class="anken-detail">スマートフォンゲームの開発スクリプター</dd>
		...
		<dt class="anken-title">業務内容</dt>
			<dd class="anken-detail">スマートフォンゲームにおけるノベルパートの担当</dd>
		<dt class="anken-title">必須経験(条件)</dt>
			<dd class="anken-detail">・ポートフォリオの提出</dd>
			<dd class="anken-detail">・スクリプターとして実務でスマホゲームのノベルパート開発に携わった経験</dd>
			<dd class="anken-detail">・スクリプトに関する成果物の提出</dd>
		<dt class="anken-title">歓迎経験<dt>
			<dd class="anken-detail">・リーダー経験やスケジュール管理の経験</dd>
			<dd class="anken-detail">・Live2Dや3Dのモーション作成経験</dd>
			<dd class="anken-detail">・スクリプトのエフェクト発注経験</dd>
