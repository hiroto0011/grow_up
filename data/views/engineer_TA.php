...
echo $this->layout('contentArea', array(
	...
	echo $this->layout('contentArea', array(
		...
		'スキルシート' => 'engineer_TA.php#skillsheet'
	)
	));
}
?>
  ...
  <div class="contentsl_1">
    <dl>
		...
		<dt class="anken-title">業務経験</dt>
			...
			<dd class="anken-detail">・clip studio paintなどを用いたイラスト作成</dd>	
        ...
        <ul class="owl-carousel">
            <div class="item"><a href="img/engineer/TA1.jpg"><img src="img/engineer/TA1.jpg"></a></div>
            <div class="item"><a href="img/engineer/TA2.png"><img src="img/engineer/TA2.png"></a></div>
            <div class="item"><a href="img/engineer/TA3.png"><img src="img/engineer/TA3.png"></a></div>
            <div class="item"><a href="img/engineer/TA4.png"><img src="img/engineer/TA4.png"></a></div>
            <div class="item"><a href="img/engineer/TA5.jpg"><img src="img/engineer/TA5.jpg"></a></div>
        </ul> 
        </div>
		<hr color="#7FC3EA">
		...
		<a href="skillsheet/TA_skillsheet.pdf"><button  class="btn btn-primary">スキルシートをダウンロード</button></a>
		</div>
