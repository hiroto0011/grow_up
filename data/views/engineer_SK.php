...
echo $this->layout('contentArea', array(
	...
	echo $this->layout('contentArea', array(
		...
		'スキルシート' => 'engineer_SK.php#skillsheet'
	)
	));
}
?>
...
<div id="contentsLeft">
  <div class="contentsl_1">
    <dl>
		...
		<div class="row">
		  <div class="column">
			...
			<dt class="anken-title">使用ツール</dt>
				<dd class="anken-detail">ブロックデータ(画像)作成時ペイントツール使用</dd>
			...
			<dt class="anken-title">制作期間</dt>
				<dd class="anken-detail">3週間</dd>	
		  </div>
		  <div class="column">
			<h3 style="text-align:center;">テトリス</h3>
			<div style="width: 100%; height: 0px; position: relative; padding-bottom: 56.250%;">
	            <video  class="embed-responsive-item" src="./videos/sk-01.mp4" controls controlslist="nodownload" oncontextmenu="return false;" id="vid_download" width="100%" >
		...
		<div class="row">
		  <div class="column">
			...
			<dt class="anken-title">開発人数</dt>
				<dd class="anken-detail">1人</dd>
			<dt class="anken-title">制作期間</dt>
				<dd class="anken-detail">2日</dd>	
		  </div>
		  <div class="column">
			<h3 style="text-align:center;">ボタン画面</h3>
			<div style="width: 100%; height: 0px; position: relative; padding-bottom: 56.250%;">
	            <video  class="embed-responsive-item" src="./videos/sk-02.mp4" controls controlslist="nodownload" oncontextmenu="return false;" id="vid_download" width="100%" >
	            <p>このブラウザは video に未対応です。</p>
	            </video>
        	</div>
		  </div>
		...
		<a href="skillsheet/SK_skillsheet.pdf"><button  class="btn btn-primary">スキルシートをダウンロード</button></a>
		</div>
