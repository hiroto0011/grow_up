...
echo $this->layout('contentArea', array(
	...
	echo $this->layout('contentArea', array(
		...
		'スキルシート' => 'engineer_KR.php#skillsheet'
	)
	));
}
?>
  ...
  <div class="contentsl_1">
    <dl>
		...
		<div class="row">
		  ...
		  <div class="column">
			<h3 style="text-align:center;">JAVA入力</h3>
			<div style="width: 100%; height: 0px; position: relative; padding-bottom: 56.250%;">
	            <video  class="embed-responsive-item" src="./videos/kr-01.mp4" controls controlslist="nodownload" oncontextmenu="return false;" id="vid_download" width="100%" >
		...
		<div class="row">
		  ...
		  <div class="column">
			...
			<div style="width: 100%; height: 0px; position: relative; padding-bottom: 56.250%;">
	            <video  class="embed-responsive-item" src="./videos/kr-02.mp4" controls controlslist="nodownload" oncontextmenu="return false;" id="vid_download" width="100%" >
	            <p>このブラウザは video に未対応です。</p>
	            </video>
        	</div>
		  </div>
		...
		<div class="row">
		  ...
		  <div class="column">
			...
			<div style="width: 100%; height: 0px; position: relative; padding-bottom: 56.250%;">
	            <video  class="embed-responsive-item" src="./videos/kr-03.mp4" controls controlslist="nodownload" oncontextmenu="return false;" id="vid_download" width="100%" >
	            <p>このブラウザは video に未対応です。</p>
	            </video>
        	</div>
		  </div>
		...
		<div class="row">
		  <div class="column">
			<dt class="anken-title">開発環境</dt>
				<dd class="anken-detail">Linux</dd>
			<dt class="anken-title">使用ツール</dt>
				<dd class="anken-detail">コンソール</dd>
			<dt class="anken-title">開発人数</dt>
				<dd class="anken-detail">1人</dd>
		  </div>
		  <div class="column">
			...
			<div style="width: 100%; height: 0px; position: relative; padding-bottom: 56.250%;">
	            <video  class="embed-responsive-item" src="./videos/kr-04.mp4" controls controlslist="nodownload" oncontextmenu="return false;" id="vid_download" width="100%" >
	            <p>このブラウザは video に未対応です。</p>
	            </video>
        	</div>
		  </div>
		...
		<a href="skillsheet/KR_skillsheet.pdf"><button  class="btn btn-primary">スキルシートをダウンロード</button></a>
		</div>
