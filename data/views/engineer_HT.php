...
echo $this->layout('contentArea', array(
	...
	echo $this->layout('contentArea', array(
		...
		'スキルシート' => 'engineer_HT.php#skillsheet'
	)
	));
}
?>
  ...
  <div class="contentsl_1">
    <dl>
		<dt class="anken-title">名前</dt>
			<dd class="anken-detail">HT</dd>
		<dt class="anken-title">職種</dt>
			<dd class="anken-detail">ライター</dd>
		...
		<a href="skillsheet/HT_skillsheet.pdf"><button  class="btn btn-primary">スキルシートをダウンロード</button></a>
		</div>
