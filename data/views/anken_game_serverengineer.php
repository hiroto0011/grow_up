...
echo $this->layout('contentArea', array(
	'title' => 'スマートフォンゲームの開発サーバーサイドエンジニアの案件',
	'content' => $this->yield('content'),
	'breadcrumbs' => array(
		'TOP',
		'案件情報',
		'スマートフォンゲームの開発サーバーサイドエンジニアの案件'
	),
	'sidebar_menu' => array(
  ...
  <div class="contentsl_1">
	<dl>
		<dt class="anken-title">案件名</dt>
			<dd class="anken-detail">スマートフォンゲームの開発サーバーサイドエンジニア</dd>
		...
		<dt class="anken-title">使用ソフト</dt>
			<dd class="anken-detail">・C#,Java,PHP,Perl,HTML</dd>
			<dd class="anken-detail">・MySQL,Oracle,PostgreSQL</dd>
			<dd class="anken-detail">・Linux,Apache,Socket</dd>
			<dd class="anken-detail">・Unity,uGUI</dd>
		<dt class="anken-title">必須経験(条件)</dt>
			<dd class="anken-detail">・ウェブサービスの開発運用経験</dd>
			<dd class="anken-detail">・WEB系プログラミングの言語、データベース言語の使用経験</dd>
		<dt class="anken-title">歓迎経験<dt>
			<dd class="anken-detail">・Unityによるゲーム開発経験</dd>
			<dd class="anken-detail">・サーバを構築した経験</dd>
			<dd class="anken-detail">・PC・スマートフォンなどのアプリケーション開発経験</dd>
			<dd class="anken-detail">・スマートフォンゲームの開発・運用経験</dd>
			<dd class="anken-detail">・LAMP環境での開発経験</dd>
