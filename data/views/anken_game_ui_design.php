...
echo $this->layout('contentArea', array(
	'title' => 'スマートフォンゲームの開発UIデザイナーの案件',
	'content' => $this->yield('content'),
	'breadcrumbs' => array(
		'TOP',
		'案件情報',
		'スマートフォンゲームの開発UIデザイナーの案件'
	),
	'sidebar_menu' => array(
  ...
  <div class="contentsl_1">
	<dl>
		<dt class="anken-title">案件名</dt>
			<dd class="anken-detail">スマートフォンゲームの開発UIデザイナー</dd>
		...
		<dt class="anken-title">業務内容</dt>
			<dd class="anken-detail">・スマートフォンゲームのUIデザイン・実装</dd>
			<dd class="anken-detail">・アイコン・グラフィック制作</dd>
		...
		<dt class="anken-title">必須経験(条件)</dt>
			<dd class="anken-detail">・ポートフォリオの提出</dd>
			<dd class="anken-detail">・スマートフォンゲームのバナー作成を得意としている方</dd>
			<dd class="anken-detail">・シンプルなデザインを量産できる方</dd>
			<dd class="anken-detail">・UI/UXの基本的知識を持っている方</dd>
		<dt class="anken-title">歓迎経験<dt>
			<dd class="anken-detail">・Unity,Live2D,Flash,Spine等を用いたアニメーション制作経験やUIデザイン経験</dd>
			<dd class="anken-detail">・Webデザインの実務経験</dd>
			<dd class="anken-detail">・ゲームグラフィックの制作経験</dd>
